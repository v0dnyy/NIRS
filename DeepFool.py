...
def deepfool(model, img_tensor, eps, num_iter):
    # Перемещаем изображение на GPU
    ...
    with torch.set_grad_enabled(True):
        for i in range(num_iter):
            ...
            # Обновляем изображение с учетом perturbation
...
def main():
    ...
    adv = deepfool(model, img_tensor, 0.03, 5)
