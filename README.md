...
- **ResNet50**<br>
  ...
  Точность модели на тестовом наборе при eps=0.001 и 10 итерациях: 18.00

  Количество изображений, поменявших свой класс: 164

  ![image](images/i_fgsm/resnet50/1.png)

  Точность модели на тестовом наборе при eps=0.005 и 10 итерациях: 2.00

  Количество изображений, поменявших свой класс: 196

  ![image](images/i_fgsm/resnet50/2.png)

  Точность модели на тестовом наборе при eps=0.01 и 10 итерациях: 2.00

  Количество изображений, поменявших свой класс: 196

  ![image](images/i_fgsm/resnet50/3.png)

  Точность модели на тестовом наборе при eps=0.05 и 10 итерациях: 1.00

  Количество изображений, поменявших свой класс: 198

  ![image](images/i_fgsm/resnet50/4.png)

  Точность модели на тестовом наборе при eps=0.1 и 10 итерациях: 0.50

  Количество изображений, поменявших свой класс: 199

  ![image](images/i_fgsm/resnet50/5.png)

  Точность модели на тестовом наборе при eps=0.15 и 10 итерациях: 0.50
